...
class resnet18_monodepth2(nn.Module):
    def __init__(self, freeze_encoder=True):
        super().__init__()
        self.backbone_po_depth = ResnetEncoder(18, True)
        ...
        if freeze_encoder:
            print("[Warning] Freezing resnet18_monodepth2 encoder.")
            self.freeze_encoder()
...
if __name__ == '__main__':
    ...
    print('resnet18_monodepth2')
    model = resnet18_monodepth2()
